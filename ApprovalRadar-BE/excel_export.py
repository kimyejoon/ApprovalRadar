...
def generate_excel_export(start_date: Optional[str], end_date: Optional[str], search: Optional[str] = None, regions: Optional[list] = None, infer_update_type: Optional[str] = None) -> io.BytesIO:
    """
    ...
    with get_db() as conn:
        ...
        where_clause, params = repo._build_where_clause(search, start_date, end_date, regions, infer_update_type)
