...
def run_scraper_job():
    ...
    try:
        ...
        for row in new_data_rows:
            ...
            raw_repo.insert_raw_data(lcns_no, json.dumps(row, ensure_ascii=False), now)
            ...
            db_record = business_repo.get_business_by_license_no(lcns_no)
            ...
            if not db_record:
                ...
                business_repo.insert_business(record)
            else:
                ...
                if is_updated:
                    ...
                    business_repo.update_business(lcns_no, updates)
