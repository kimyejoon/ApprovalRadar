...
export default function App() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      const startStr = state.dateRange?.from ? format(state.dateRange.from, 'yyyyMMdd') : undefined;
      const endStr = state.dateRange?.to ? format(state.dateRange.to, 'yyyyMMdd') : undefined;
