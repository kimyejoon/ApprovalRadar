...
async def run_tests():
    ...
    # Query for tomorrow 20260522 (which is in the future)
    future_str = "20260522"
    
    urls = [
        # I2861 Tests
        ("I2861 Plain (Future)", f"http://openapi.foodsafetykorea.go.kr/api/{api_key}/I2861/json/1/5/CHNG_DT={future_str}", "I2861"),
        ("I2861 Ampersand (Future & SYS_SYNC=LIVE)", f"http://openapi.foodsafetykorea.go.kr/api/{api_key}/I2861/json/1/5/CHNG_DT={future_str}&SYS_SYNC=LIVE", "I2861"),
        
        # I2500 Tests
        ("I2500 Plain (Future)", f"http://openapi.foodsafetykorea.go.kr/api/{api_key}/I2500/json/1/5/CHNG_DT={future_str}", "I2500"),
        ("I2500 Ampersand (Future & SYS_SYNC=LIVE)", f"http://openapi.foodsafetykorea.go.kr/api/{api_key}/I2500/json/1/5/CHNG_DT={future_str}&SYS_SYNC=LIVE", "I2500"),
    ]
