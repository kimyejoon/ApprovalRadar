    ...
    try:
        ...
        try:
            ...
            if total_count != "N/A" and total_count.strip() and int(total_count) > 0:
                print(f"Sample row: {service_data.get('row', [])[:1]}")
        except Exception:
...
async def run_tests():
    ...
    urls = [
        # I2861 plain query with absolutely NO parameters
        ("I2861 Plain No Params", f"http://openapi.foodsafetykorea.go.kr/api/{api_key}/I2861/json/1/5", "I2861"),
        # I2500 plain query with absolutely NO parameters
        ("I2500 Plain No Params", f"http://openapi.foodsafetykorea.go.kr/api/{api_key}/I2500/json/1/5", "I2500"),
    ]
